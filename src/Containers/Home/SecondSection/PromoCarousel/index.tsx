...
function PromoCarousel() {
  return (
    <>
      <h3 className="text-heading-3 text-white font-label font-bold pt-14 mb-4">Promo Liburan</h3>
      <Carousel
        className="py-5"
        ...
        customRightArrow={
          <button type="button" aria-label="Go to next slide" className="absolute z-50 right-0 opacity-50 hover:opacity-100">
            <img src="/icons/right-arrow-rounded.svg" height="75" width="75" />
          </button>
        }
        customLeftArrow={
          <button type="button" aria-label="Go to previous slide" className="absolute z-50 left-0 opacity-50 hover:opacity-100">
            <img src="/icons/left-arrow-rounded.svg" height="75" width="75" />
          </button>
        }
        partialVisible
        responsive={{
