  ...
  return (
    <article className="flex flex-col bg-white rounded-xl shadow-lg overflow-hidden w-[393px]">
      <figure className="relative w-full h-[268px]">
        <Image src="/home/cliff.png" alt="Cliff Image" layout="fill" objectFit="cover" objectPosition="center" />
      </figure>

      <div className="flex flex-col p-4">
        <div className="flex items-center mb-4">
          <Image src="/icons/yellow-star.svg" alt="Yellow Star" height="20" width="20" />

          <p className="text-heading-5 text-gray-70 ml-1">4.6 (1.241 Review)</p>
        </div>
